...
export function Footer() {
  ...
  if (recipe.footer === 'editorial-footer') {
    return (
      <footer className="border-t border-white/[0.08] bg-[#070708] text-zinc-100">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr_0.9fr]">
            <div>
              ...
              <h3 className="mt-5 text-3xl font-semibold lowercase tracking-[-0.04em]">{SITE_CONFIG.name}</h3>
              <p className="mt-4 max-w-md text-sm leading-7 text-zinc-500">{SITE_CONFIG.description}</p>
            </div>
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-[0.24em] text-zinc-500">Sections</h4>
            ...
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-[0.24em] text-zinc-500">Company</h4>
              <ul className="mt-4 space-y-3 text-sm text-zinc-300">
